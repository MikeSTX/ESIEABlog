blogESIEA.controller('articlesCrtl', function($scope, $location, $rootScope, $http)
{
  ...
  $scope.addNewArticle = function()
  {
    ...
    // ------------------------------------------
    var newArticle = {
      title : $scope.TitleNewArticle,
      header : $scope.textHeaderNewArticle,
      content : $scope.textContentNewArticle,
  ...
  $scope.deleteArticle = function(idArticle)
  {
    ...
    $http.post('http://localhost:8000/deleteArticle', {idArticle}).then(function(response)
    {
      ...
      $rootScope.ServerInformation = {
        ...
        'iconViewNOK': false,
        'iconViewInfo': true,
        'label': 'Your article has been removed'
      };
